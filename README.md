...
- [**gradience-hydroxy-fork-git**](url='https://github.com/hydroxycarbamide/Gradience'): pkgdesc='Change the look of Adwaita, with ease (hydroxycarbamide fork)'
...
- [**morghulis**](https://github.com/ARKye03/morghulis): Wayland GTK4 Desktop Shell
